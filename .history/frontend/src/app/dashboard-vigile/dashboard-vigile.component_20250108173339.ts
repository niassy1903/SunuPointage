...
export class DashboardVigileComponent implements OnInit, OnDestroy {
  ...
  // Chargement des données des pointages
  loadPointagesData(): void {
    ...
    this.pointageService.getTotalPointages(today).subscribe(
      (data) => {
        ...
        this.updateCardValue(0, this.totalPointages); // Mettez à jour la carte 1
      },
      (error) => {
    ...
    this.pointageService.getTotalValidations(today).subscribe(
      (data) => {
        ...
        this.updateCardValue(1, this.totalValidations); // Mettez à jour la carte 2
      },
      (error) => {
    ...
    this.pointageService.getTotalRejets(today).subscribe(
      (data) => {
        ...
        this.updateCardValue(2, this.totalRejets); // Mettez à jour la carte 3
      },
      (error) => {
