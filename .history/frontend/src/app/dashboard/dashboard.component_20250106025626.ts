...
export class DashboardComponent implements OnInit {
  ...
  getPointageStatistics(date: string) {
    this.pointageService.getPointageStatistics(date).subscribe((data) => {
      ...
      this.updateCardValue('A l\'heure', data['validés']); // Remplace 'validés' avec la bonne clé de ton retour
      this.updateCardValue('Absent', data['rejetés']); // Remplace 'rejetés' avec la bonne clé de ton retour
      this.updateCardValue('Arrivée tardive', data['tardifs']); // Remplace 'tardifs' avec la bonne clé de ton retour
      this.updateCardValue('Départs anticipés', data['anticipés']); // Remplace 'anticipés' avec la bonne clé de ton retour
      this.updateCardValue('Départs Tardives', data['tardifs']); // Remplace 'tardifs' avec la bonne clé de ton retour
    });
  }
