...
class Utilisateur extends Model implements CanResetPassword, JWTSubject // Implémentez JWTSubject
{
    use Notifiable, CanResetPasswordTrait, HasApiTokens;
    ...
    protected $fillable = [
        'nom', 'prenom', 'email', 'adresse', 'telephone', 'fonction', 'photo',
        'mot_de_passe', 'date_creation', 'date_suppression', 'date_modification',
        'departement', 'cohorte', 'matricule', 'status', 'card_id',
    ];
    ...
    {
        return $this->getKey(); // Retourne l'ID unique de l'utilisateur (ID par défaut dans MongoDB)
    }

    public function getJWTCustomClaims()
    {
        return []; // Vous pouvez ajouter des informations personnalisées ici si nécessaire
    }
