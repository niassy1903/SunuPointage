    ...
    public function getTotalValidations(Request $request)
{
    ...
    // Effectuer la recherche dans MongoDB pour les pointages validés entre le début et la fin de la journée
    $totalValidations = Pointage::whereBetween('date_actuelle', [$startOfDay, $endOfDay])
