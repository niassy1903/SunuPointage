    ...
    public function getUtilisateurByCardId($cardId)
{
    ...
    public function login(Request $request)
    {
        ...
        // Si la validation échoue, Laravel renverra une réponse JSON automatiquement avec les erreurs.
        // Si vous voulez personnaliser le message ou renvoyer un code d'erreur particulier, vous pouvez faire comme suit :
        ...
        // Assurez-vous de créer un token avec JWT ou Sanctum
