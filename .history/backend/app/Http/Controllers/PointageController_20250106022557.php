...
class PointageController extends Controller
{
    ...
    public function filterPointages($date)
    {
        $pointages = Pointage::whereDate('date_actuelle', $date)->get();

        $filteredPointages = $pointages->map(function ($pointage) {
            ...
            if (!$heureArrivee) {
                ...
                $pointage->statut = 'depart_anticipé';
            } elseif ($heureDepart && $heureDepart > '17:00') {
                $pointage->statut = 'depart_tardif';
            } else {
        ...
        return response()->json($filteredPointages);
    }
}
